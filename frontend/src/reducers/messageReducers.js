...
export const createConversationReducer = (state = { conversation: [] }, action) => {
    switch (action.type) {
      case CREATE_CONVERSATION_REQUEST:
        return { ...state, loading: true };
      case  CREATE_CONVERSATION_SUCCESS:
        return { ...state, loading: false,success:true, conversation: action.payload };
  ...
  export const getConversationReducer = (state = { conversation: [] }, action) => {
    switch (action.type) {
  ...
  export const getMessageReducer = (state = { messages: [] }, action) => {
    switch (action.type) {
      ...
      case  GET_MESSAGES_SUCCESS:
        return { ...state, loading: false,success:true, messages:action.payload };
